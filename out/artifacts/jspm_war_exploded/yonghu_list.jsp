...
<td> <% if( "".equals( map.get("touxiang") ) ){ %>-<% } else { %><img width="100" src="<%= map.get("touxiang") %>"/><% } %> </td>
                        ...
                        <td align="center">
                                                                ...
                                                                <a href="yonghu_updt.jsp?id=<%= map.get("id") %>" class="btn btn-xs btn-success">编辑</a>
                                                                <a href="yonghu.jsp?a=delete&id=<%= map.get("id") %>" class="btn btn-xs btn-danger" onclick="return confirm('确定要删除？')">删除</a>
                                                        <!--qiatnalijne-->
                        </td>
                    </tr>
                    <% } %>

...
<div class="panel panel-default">
    ...
    基金类型
                            ...
                            <select class="form-control class_jijinleixing8" data-value="<%= request.getParameter("jijinleixing") !=null ? request.getParameter("jijinleixing") : "" %>" id="jijinleixing" name="jijinleixing">
...
<script>
$(".class_jijinleixing8").val($(".class_jijinleixing8").attr("data-value"))</script>
                        
</div>
                                                                                    <div class="form-group">
    风险类型
    
                            <select class="form-control class_fengxianleixing9" data-value="<%= request.getParameter("fengxianleixing") !=null ? request.getParameter("fengxianleixing") : "" %>" id="fengxianleixing" name="fengxianleixing">
...
<script>
$(".class_fengxianleixing9").val($(".class_fengxianleixing9").attr("data-value"))</script>
...
<td> <% 
 HashMap mapjijinfenlei3 = new CommDAO().find("SELECT fenleimingcheng FROM jijinfenlei where id='"+map.get("jijinleixing")+"'"); 
 %><%= mapjijinfenlei3.get("fenleimingcheng") %> </td>
...
<td> <%= map.get("faburen") %> </td>
                        ...
                        <td align="center">
                                                                ...
                                                                <a href="gouwuche_add.jsp?id=<%= map.get("id") %>" class="btn btn-xs btn-primary">添加购物车</a>
                                                                <a href="gouwuche_list.jsp?jijinxinxiid=<%= map.get("id") %>" class="btn btn-xs btn-default">查询购物车</a>
                                    ...
                                    详细
                                                                ...
                                                                <a href="jijinxinxi.jsp?a=delete&id=<%= map.get("id") %>" class="btn btn-xs btn-danger" onclick="return confirm('确定要删除？')">删除</a>
                                                        <!--qiatnalijne-->
                        </td>
                    </tr>
                    <% } %>

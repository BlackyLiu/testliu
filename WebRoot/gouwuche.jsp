...
new CommDAO().commOper("UPDATE gouwuche SET xiaoji=(mairuzhishu*jijinjiage) WHERE id='"+charuid+"'");
    ...
    new CommDAO().commOper("UPDATE gouwuche SET xiaoji=(mairuzhishu*jijinjiage) WHERE id='"+request.getParameter("id")+"'");
    ...
    // 获取一行数据
    HashMap map = Query.make("gouwuche").find(Request.get("id"));

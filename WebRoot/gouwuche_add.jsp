...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <% 
 HashMap mapjijinfenlei13 = new CommDAO().find("SELECT fenleimingcheng FROM jijinfenlei where id='"+readMap.get("jijinleixing")+"'"); 
 %><%= mapjijinfenlei13.get("fenleimingcheng") %><input type="hidden" id="jijinleixing" name="jijinleixing" value="<%= Info.html(readMap.get("jijinleixing")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">

...
<div class="panel panel-default">
    ...
    基金类型
                            ...
                            <select class="form-control class_jijinleixing16" data-value="<%= request.getParameter("jijinleixing") !=null ? request.getParameter("jijinleixing") : "" %>" id="jijinleixing" name="jijinleixing">
...
<script>
$(".class_jijinleixing16").val($(".class_jijinleixing16").attr("data-value"))</script>
                        
</div>
                                                                <div class="form-group">
    风险类型
    
                            <select class="form-control class_fengxianleixing17" data-value="<%= request.getParameter("fengxianleixing") !=null ? request.getParameter("fengxianleixing") : "" %>" id="fengxianleixing" name="fengxianleixing">
...
<script>
$(".class_fengxianleixing17").val($(".class_fengxianleixing17").attr("data-value"))</script>
...
<td> <% 
 HashMap mapjijinfenlei10 = new CommDAO().find("SELECT fenleimingcheng FROM jijinfenlei where id='"+map.get("jijinleixing")+"'"); 
 %><%= mapjijinfenlei10.get("fenleimingcheng") %> </td>
...
<td> <%= map.get("goumairen") %> </td>
                        ...
                        <td align="center">
                                    ...
                                    详细
                                                                ...
                                                                <a href="gouwuche_updt.jsp?id=<%= map.get("id") %>" class="btn btn-xs btn-default">编辑</a>
                                                                <a href="gouwuche.jsp?a=delete&id=<%= map.get("id") %>" class="btn btn-xs btn-danger" onclick="return confirm('确定要删除？')">删除</a>
                                                        <!--qiatnalijne-->
                        </td>
                    </tr>
                    <% } %>

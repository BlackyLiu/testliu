...
<section id="container" class="">
    ...
    <header class="header white-bg">
        ...
        <!--logo start-->
        <a href="javascript:;" class="logo">网络基金商城系统</a>
        <!--logo end-->
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        ...
                        <img alt="" src="<%= request.getSession().getAttribute("touxiang") !=null ? request.getSession().getAttribute("touxiang") : "" %>" style="width: 29px;height: 29px;">
                        <% } else { %>
                    ...
                    <ul class="dropdown-menu extended logout">
                        ...
                        <li><a href="mod.jsp" target="main"><i class="icon-cog"></i> 修改密码</a></li>
                        <li><a href="sy.jsp" target="main"><i class="icon-bell-alt"></i> 后台首页</a></li>
                        <li><a href="logout.jsp" onclick="return confirm('确定退出系统？')"><i class="icon-key"></i>
                            退出系统</a></li>
                    </ul>
                </li>
    ...
    <section id="main-content">
        <section class="wrapper" style="">
            <iframe name="main" src="sy.jsp"></iframe>
        </section>
    </section>
    <!--main content end-->
</section>

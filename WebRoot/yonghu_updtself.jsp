...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写用户名" remote="factory/checkno.jsp?checktype=update&id=<%= mmm.get("id") %>&table=yonghu&col=yonghuming" data-msg-remote="内容重复了" id="yonghuming" name="yonghuming" value="<%= Info.html(mmm.get("yonghuming")) %>"/>                                            
        </div>
    </div>
</div>
                                                                            <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_xingbie3" data-value="<%= Info.html(mmm.get("xingbie")) %>" id="xingbie" name="xingbie" style="width:250px">
...
$(".class_xingbie3").val($(".class_xingbie3").attr("data-value"))</script>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" tel="true" data-msg-phone="请输入正确固定号码" id="shouji" name="shouji" value="<%= Info.html(mmm.get("shouji")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
